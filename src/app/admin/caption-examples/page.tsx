  ...
  return (
    <section className="w-full rounded-xl bg-white p-6 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Caption Examples</h1>
          <p className="mt-2 text-sm text-slate-600">Manage caption example records.</p>
        </div>
        <Link
      ...
      {error ? (
        <p className="mt-4 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
          Unable to load caption examples right now.
        </p>
      ) : null}
          ...
          <tbody className="divide-y divide-slate-200 bg-white">
            {examples && examples.length > 0 ? (
              ...
              <tr>
                ...
                >
                  {error
                    ? "Unable to display caption examples."
